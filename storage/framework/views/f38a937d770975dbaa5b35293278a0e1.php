...
<body>
<form action="<?php echo e(route('admin.match')); ?>"  method="POST" class="form-box">
  ...
  <div class="container signin">
    <p>Dont have an account? <a  href="<?php echo e(route('admin.register')); ?>" >Register</a>.</p>
  </div>
  
</form>
</body>
</html><?php /**PATH D:\xampp\htdocs\auth-app\resources\views/Admin/admin-login.blade.php ENDPATH**/ ?>