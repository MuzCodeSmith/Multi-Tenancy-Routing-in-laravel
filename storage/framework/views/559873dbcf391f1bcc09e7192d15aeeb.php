...
<body>
<form action="<?php echo e(route('login.user')); ?>" method="POST" class="form-box">
    <?php echo csrf_field(); ?>
  <div class="container">
  <?php if($errors): ?>
  ...
  <div class="container signin">
    <p>Dont have an account? <a href="<?php echo e(route('register.page')); ?>">Register</a>.</p>
  </div>
</form>
</body>
</html><?php /**PATH D:\xampp\htdocs\auth-app\resources\views/login-page.blade.php ENDPATH**/ ?>