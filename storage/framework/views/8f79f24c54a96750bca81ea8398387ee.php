...
<body>
<form action="<?php echo e(route('teacher.save')); ?>" method="POST" class="form-box">
    <?php echo csrf_field(); ?>
  <div class="container"> 
  ...
  <div class="container signin">
    <p>Already have an account? <a href="<?php echo e(route('teacher.login')); ?>">Sign in</a>.</p>
  </div>
</form>
</body>
</html><?php /**PATH D:\xampp\htdocs\auth-app\resources\views/Teacher/teacher-register.blade.php ENDPATH**/ ?>