...
<body>
<form action="<?php echo e(route('student.save')); ?>" method="POST" class="form-box">
    <?php echo csrf_field(); ?>
  <div class="container"> 
  ...
  <div class="container signin">
    <p>Already have an account? <a href="<?php echo e(route('student.login')); ?>">Sign in</a>.</p>
  </div>
</form>
</body>
</html><?php /**PATH D:\xampp\htdocs\auth-app\resources\views/Student/student-register.blade.php ENDPATH**/ ?>