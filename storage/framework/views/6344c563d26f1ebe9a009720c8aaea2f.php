...
<body>
<form action="<?php echo e(route('register.user')); ?>" method="POST" class="form-box">
    <?php echo csrf_field(); ?>
  <div class="container"> 
    <h1>Register</h1>
  ...
  <div class="container signin">
    <p>Already have an account? <a href="<?php echo e(route('login.page')); ?>">Sign in</a>.</p>
  </div>
</form>
</body>
</html><?php /**PATH D:\xampp\htdocs\auth-app\resources\views/register-page.blade.php ENDPATH**/ ?>